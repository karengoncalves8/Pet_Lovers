...
import { DataGrid, GridRowModesModel, GridColDef, GridActionsCellItem, GridRowId, GridSlots, GridToolbarContainer } from '@mui/x-data-grid';
...
interface TableToolbarProps {
    toggleAddModal: (newOpen) => MouseEventHandler<HTMLButtonElement>
}
...
export default class Clientes extends Component<{}, State> {
    ...
    toggleAddModal = (newOpen: boolean) => () => {
        this.setState({openAddModal: newOpen})
    };
    ...
    setRows = (newRows: (oldRows: Cliente[]) => Cliente []) => {
            ...
            <main className='tabela'>
                ...
                <CardPaper className='cardp-table'>
                    <DataGrid
                        ...
                        slotProps={{ toolbar: { toggleAddModal: this.toggleAddModal} }}
                    />
                </CardPaper>
                ...
                <Drawer
                    ...
                    <Box sx={{ width: 300, padding: 2 }}>
                        ...
                        <>
                            <ClienteDetails clietInformation={this.state.selectedRow} />
                        </>
                        ) : (
                        <p>Carregando...</p>
                        )}
                    ...
                    <Box className="box-modal">
                        <div className='modal-cadastro-cliente'>
                            <div className="modal-title">
                                ...
                                <IoCloseOutline size={28} className='close-btn' onClick={this.toggleAddModal(false)}/>
                            </div>
                            <CadastrarCliente/>
                        </div>
                    </Box>
