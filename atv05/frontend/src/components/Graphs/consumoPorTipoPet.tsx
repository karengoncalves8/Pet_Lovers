...
import { ConsumoPorTipoPet, estatisticasServices } from "../../services/estatisticasServices";
...
const processData = (data) => {
    ...
    data.forEach((item) => {
      const entry = { pet_tipo: item.pet_tipo };
...
const GraficoConsumiveisPorTipoPet: React.FC = () =>{ 
    const [ data, setData ] = useState<Array<ConsumoPorTipoPet>>([]);

    const fetchData = async () => {
        const result = await estatisticasServices.getConsumoPorTipoPet()
...
export default GraficoConsumiveisPorTipoPet